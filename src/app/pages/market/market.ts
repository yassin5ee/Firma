        ...
        <section class="product-grid">
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="btn-buy" routerLink="/detail" [queryParams]="{id: '1'}">Voir détails</button>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="btn-buy" routerLink="/detail" [queryParams]="{id: '2'}">Voir détails</button>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="btn-buy" routerLink="/detail" [queryParams]="{id: '3'}">Voir détails</button>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="btn-buy" routerLink="/detail" [queryParams]="{id: '4'}">Voir détails</button>
                </div>
            </div>
